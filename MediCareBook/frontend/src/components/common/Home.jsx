    ...
    <>
      ...
      <div className="center-box">
        <Carousel className="my-4">
          <Carousel.Item>
            <img className="d-block w-100" src={dentist} alt="Dentist" />
            <Carousel.Caption>
              <h3>Dentist</h3>
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={general} alt="General Physician" />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={baby} alt="Pediatrician" />
            <Carousel.Caption>
              <h3>Pediatrician</h3>
              <p>Child specialists and doctors for infants</p>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img className="d-block w-100" src={pregnant} alt="Gynecologist" />
            <Carousel.Caption>
              <h3>Gynecologist/Obstetrician</h3>
              <p>Explore treatments for women's health, pregnancy, and infertility</p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
      </div>
